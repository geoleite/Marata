 ...
 * @author geoleite
 */
public class Gj_gnfe_nota_fiscalConsultEmail extends Gj_gnfe_nota_fiscalConsultClienteGWT {

    public Gj_gnfe_nota_fiscalConsultEmail() {
    ...
    public void load() {
        gj_gnfe_nota_fiscalDao.consultByEmail();
