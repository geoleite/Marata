 ...
 * @author geoleite
 */
public class Gj_gnfe_nota_fiscalInsertGWT extends CadastrarBaseGWT {
    ...
    public Gj_gnfe_nota_fiscalInsertGWT() {
        setHeading("Cadastrar Gj_gnfe_nota_fiscal");
    ...
    public void btnInsertAction(ButtonEvent ce) {
        Gj_gnfe_nota_fiscalTGWT gj_gnfe_nota_fiscalT = new Gj_gnfe_nota_fiscalTGWT();
        ...
        gj_gnfe_nota_fiscalDao.inserir(gj_gnfe_nota_fiscalT);
    ...
    public void btnLimpartAction(ButtonEvent ce) {
        ...
        modalidade.setValue("");
        status.setValue("");
        cstatus_sefr.setValue("");
        xmot_sefr.setValue("");
        xml_sig.setValue("");
        xml_sig_mail.setValue("");
        prot.setValue("");
        //date_prot.setValue("");
        xml_prot.setValue("");
        xml_prot_mail.setValue("");
        origem.setValue("");
        status_java.setValue("");
        status_totvs.setValue("");
        totvs_cod_empresa.setValue("");
        totvs_num_ar.setValue("");
        totvs_num_nfe.setValue("");
        totvs_ser_nfe.setValue("");
        totvs_ssr_nfe.setValue("");
        totvs_emi_nfe.setValue("");
        totvs_des_nfe.setValue("");
        totvs_dat_nfe.setValue(null);
        totvs_val_nfe.setValue("");
        num_cgc_cpf.setValue("");
