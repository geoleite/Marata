...
import br.com.easynet.nfegen.transfer.DadosAssinaturaT;
import br.com.easynet.nfegen.transfer.DadosCobrancaT;
import br.com.easynet.nfegen.transfer.DadosConfinsT;
import br.com.easynet.nfegen.transfer.DadosDestT;
import br.com.easynet.nfegen.transfer.DadosDetT;
import br.com.easynet.nfegen.transfer.DadosEmissorT;
import br.com.easynet.nfegen.transfer.DadosICMST;
import br.com.easynet.nfegen.transfer.DadosIDET;
import br.com.easynet.nfegen.transfer.DadosImpostoT;
import br.com.easynet.nfegen.transfer.DadosInformacoesAdicionaisT;
import br.com.easynet.nfegen.transfer.DadosNFET;
import br.com.easynet.nfegen.transfer.DadosPisT;
import br.com.easynet.nfegen.transfer.DadosTotalT;
import br.com.easynet.nfegen.transfer.DadosTranspT;
 ...
 * @author geoleite
 */
public class RelatorioNFEJB extends SystemBase implements br.com.easynet.easyportal.jb.INotSecurity {
    ...
    public void consult() {
        try {
            String chaveAcesso = not_notaT.getNot_tx_identificador();
            if (chaveAcesso == null || chaveAcesso.trim().length() == 0) {
                setMsg("Chave de Acesso nao informada!");
                return;
            }
            if (chaveAcesso.indexOf("NFe") == -1) {
                not_notaT.setNot_tx_identificador("NFe" + not_notaT.getNot_tx_identificador());
            }
            List<Not_notaT> list = getNot_notaDAO().getByNot_tx_identificadorDownloadNota(not_notaT);
            if (list.size() > 0) {
                achou = true;
                not_notaT = list.get(0);
                ...
                dadosCobrancaT.setNumero(not_notaT.getNot_tx_identificador());
    ...
    public String getChaveAcessoFormatado() {
        try {
            ...
            String str = not_notaT.getNot_tx_identificador();
