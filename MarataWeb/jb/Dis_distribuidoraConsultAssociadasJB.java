...
public class Dis_distribuidoraConsultAssociadasJB extends SystemBase {
    ...
    public void consult() throws Exception {
        try {
            ...
            dis_distribuidoraT.setDis_nr_id(getUsuarioLogado().getUsu_nr_id());
            list = dis_distribuidoraDAO.getAllDistribuidorasAssociadas(dis_distribuidoraT);
        } catch (Exception e) {
            e.printStackTrace();
