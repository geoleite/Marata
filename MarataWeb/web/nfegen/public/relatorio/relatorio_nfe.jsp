...
<c:forEach var="item" items="${relatorio.abas}" begin="0" end="8" step="1">
    ...
    function createImpressao() {
        open('portal_Relatorio.jsp?not_notaT.not_tx_identificador=${relatorio.not_notaT.not_tx_identificador}&urlCanalAtual=principalPage.jsp&urlCanal=/nfegen/public/relatorio/relatorio_nfe_impressao.jsp&op=consult&');
//        window.open('portal_Relatorio.jsp?not_notaT.not_tx_identificador=${relatorio.not_notaT.not_tx_identificador}&urlCanalAtual=principalPage.jsp&urlCanal=/nfegen/public/relatorio/relatorio_nfe_impressao.jsp&op=consult&', 'impressao' + new Date(), '');
    }
    //-->
</script>
<h3 style="width:800" class="relatorio_linhas_titulo">Consulta NFE</h3>
<h3 style="color: red">${relatorio.msg}</h3>
<form name="relatorio" action="portal.jsp" method="post">
    <input type="hidden" name="op"/>
    <input type="hidden" name="urlCanalAtual" value="principalPage.jsp"/>
    <input type="hidden" name="urlCanal" value="/nfegen/public/relatorio/relatorio_nfe.jsp"/>
    <input type="hidden" name="abaSelecionada" value="${relatorio.abaSelecionada}"/>

    <c:if test="${param['versao']!='imp'}">
        <label>Chave de Acesso: </label><input size="40" name="not_notaT.not_tx_identificador" title="Informe a chave de acesso." value="${relatorio.not_notaT.not_tx_identificador}"/>
    ...
    <c:if test="${relatorio.achou}">
        <br/><br/>
        <div align="center">
            <!--input type="button" value="Versao para Impressao" onclick="document.location='portal_Relatorio.jsp?urlCanalAtual=principalPage.jsp&urlCanal=/nfegen/public/relatorio/relatorio_nfe_impressao.jsp&op=consult&not_notaT.not_tx_identificador=${relatorio.not_notaT.not_tx_identificador}'"/-->
