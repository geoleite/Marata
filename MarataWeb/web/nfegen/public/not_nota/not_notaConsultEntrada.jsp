...
<jsp:useBean id="not_notaJB" class="br.com.easynet.nfegen.jb.Not_notaConsultEntradaJB" scope="request"/>
...
<form name="not_nota" action="portal.jsp" method="post">                                         
    ...
    <input type="hidden" name="urlCanal" value="/nfegen/public/not_nota/not_notaConsultEntrada.jsp"/>
    <div align="center">     
        <label style="color:red" align="center">${not_notaJB.msg} </label>
        <br/>
        <h3>Pesquisar Notas Fiscais de Entrada</h3>
        <table>
            <tr>
                <td>
                    <label>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <input type="button" value="Pesquisar" onClick="setOpPortal('not_nota','consult', '/nfegen/public/not_nota/not_notaConsultEntrada.jsp')"/>&nbsp;&nbsp;&nbsp;
