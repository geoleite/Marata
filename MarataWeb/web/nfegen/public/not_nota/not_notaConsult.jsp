...
<form name="not_nota" action="portal.jsp" method="post">                                         
    ...
    <input type="hidden" name="urlCanal" value="/nfegen/public/not_nota/not_notaConsult.jsp"/>
    <div align="center">     
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="tipoNota" >
                        <option value="E" ${not_notaJB.tipoNota=='E'?'selected':' ' }>Entrada</option>
                        <option value="S" ${not_notaJB.tipoNota=='S'?'selected':' ' }>Saida</option>
                    </select>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    ...
                    <input type="button" value="Pesquisar" onClick="setOpPortal('not_nota','consult', '/nfegen/public/not_nota/not_notaConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
        ...
        <display:table class="tabela" cellpadding="0" cellspacing="0" id="item" name="${not_notaJB.list}"  pagesize="${not_notaJB.tamanhoConsulta}" >
            ...
            <display:column sortable="false" title="${not_notaJB.tipoNota=='S'?'Cliente':'Distribuidora'}" >
                <label>
            ...
            <display:column sortable="false" title="${not_notaJB.tipoNota=='S'?'Cnpj Cliente':'CNPJ Distribuidora'}" >
                <label>
            ...
            <display:column sortable="false" title="Download" >
