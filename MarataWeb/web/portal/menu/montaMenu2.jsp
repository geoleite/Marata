...
//--- Item Appearance FFC6C6, D02424
var itemBackColor=["#fffafa","#eaeaea"];
var itemBackImage=["",""];
var beforeItemImage=["",""];
var afterItemImage=["",""];
...
var itemStyles = [
    ["itemWidth=110px","itemHeight=21px","itemBackColor=transparent,transparent","itemBackImage=menu.files/btn3_blue.gif,menu.files/btn3_red.gif","fontStyle='normal 11px Tahoma','normal 11px Tahoma'","fontColor=#1A3953,#000000"],
];
var menuStyles = [
