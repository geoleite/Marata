...
public class DadosTotalT {
    ...
    private String vnf;
    private DadosICMSTotT dadosIcmsTotT; 
    ...
    /**
     * @return the dadosIcmsTotT
     */
    public DadosICMSTotT getDadosIcmsTotT() {
        return dadosIcmsTotT;
    }

    /**
     * @param dadosIcmsTotT the dadosIcmsTotT to set
     */
    public void setDadosIcmsTotT(DadosICMSTotT dadosIcmsTotT) {
        this.dadosIcmsTotT = dadosIcmsTotT;
    }
